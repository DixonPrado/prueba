...
class StringHelper extends \Joomla\String\StringHelper
{
	...
	public static function toCamelCase($string)
	{
		...
		return JNormalise::toVariable(self::toSpaceSeparated($string));
	}
	...
	public static function toDashCase($string, $to_lowercase = true)
	{
		...
		$string = JNormalise::toDashSeparated(self::toSpaceSeparated($string));
	...
	public static function toPascalCase($string)
	{
		...
		return JNormalise::toCamelCase(self::toSpaceSeparated($string));
	}
	 ...
	 * @return string
	 */
	public static function toSpaceSeparated($string)
	{
		$array = ArrayHelper::applyMethodToValues([$string]);
		...
		return JNormalise::toSpaceSeparated(self::fromCamelCase($string));
	}
	...
	public static function toTitleCase($string)
	{
		...
		return self::ucwords(JNormalise::toSpaceSeparated($string));
	}
	...
	public static function toUnderscoreCase($string, $to_lowercase = true)
	{
		...
		$string = JNormalise::toUnderscoreSeparated(self::toSpaceSeparated($string));
