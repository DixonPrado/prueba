 ...
 */
(function(){'use strict';window.RegularLabs=window.RegularLabs||{};window.RegularLabs.Sourcerer=window.RegularLabs.Sourcerer||{};window.RegularLabs.Sourcerer.Popup=window.RegularLabs.Sourcerer.Popup||{form:null,options:{},init:function(editor_name){if(!parent.RegularLabs.Sourcerer.Button){document.querySelector('body').innerHTML='This page cannot function on its own.';return;}
...
while(match){attributes[match[1]]=match[2];match=regex.exec(string);}
