...
JFactory::getDocument()->addStyleSheet(T4PATH_ADMIN_URI . '/vendors/spectrum/spectrum.min.css');
JFactory::getDocument()->addScript(T4PATH_ADMIN_URI . '/vendors/spectrum/spectrum.min.js');
JFactory::getDocument()->addScript(T4PATH_ADMIN_URI . '/assets/js/brand-color.js');
?>
